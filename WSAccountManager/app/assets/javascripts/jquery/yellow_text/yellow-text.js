...
//download: https://github.com/stefanvermaas/yellow-text
//it was adapted to work inside of an iframe ($, window, document, _body)
...
*
*/
;(function ( $, window, document, _body, undefined ) {
    ...
    YellowText.prototype = {
      ...
      */
      render: function() {
        ...
        this.editor = $("<iframe />").addClass( this.options.iFrameClass ).css({
          ...
          "border"  : 0,
          "overflow": "hidden"
        }, true).appendTo( this.container ).get(0);
      ...
      */
      events: function() {
        ...
        _body.find("." + this.options.buttonsClass + " a").on("click", function( e ) {
...
})( jQuery, parent_window, parent_document, parent_body );